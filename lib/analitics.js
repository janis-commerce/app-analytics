...
import {isDevEnv, formatBasicData, validObjectWithValues} from './utils';
...
class Analytics {
  ...
  constructor(params = {}) {
    this.eventData = validObjectWithValues(params) ? params : {};
  }
  ...
  async sendAction(actionName, params) {
    const validParams = validObjectWithValues(params) ? params : {};
